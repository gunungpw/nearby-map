...
<div class="card" style="width:420px;">
    ...
    <div class="card-body">
        <div class="list-group"><a href="#" onclick="addressClicked('${shape.data.id}')"
                class="list-group-item list-group-item-action d-flex gap-3 py-3"><svg width="32" height="32"
                    class="flex-shrink-0">
                    <use xlink:href="#cursor-icon" />
                </svg>
                ...
                </div><small class="text-nowrap">Directions</small>
            </a><a target="_blank" href="tel:${phone.replace(/\s/g, '')}"
                class="list-group-item list-group-item-action d-flex gap-3 py-3 ${phone === '' ? 'd-none' : ''}"><svg
                    width="32" height="32" class="flex-shrink-0">
                ...
                <div class="d-flex gap-2 w-100 justify-content-between">
                    ...
                    </div><small class="text-nowrap">POI</small>
                </div>
            </a><a target="_blank" href="http://${url.replace(/^https?\:\/\//i, '')}"
                class="list-group-item list-group-item-action d-flex gap-3 py-3 ${url === '' ? 'd-none' : ''}"><svg
                    width="32" height="32" class="flex-shrink-0">
    ...
    <div class="card-footer text-muted">${dist} km away from ${userPositionUpdated === true ? 'you' : 'the Tower of London'}</div>
</div > `
